  ...
  },
  {
    ...
    body: (
      <Text>
        ...
        religiões. Existe uma crença de que o cordão é capaz de reunir as
        energias espirituais de quem o carrega. Sua origem baseia-se, sobretudo,
        na religião hinduísta e no budismo, que consideram o japamala uma
        ferramenta eficiente para manter a mente focada e livre de pensamentos
        negativos. São diversas as técnicas de manuseio de um japamala, por
        exemplo, a pessoa pode usá-lo para fazer a contagem das pedras ao mesmo
        tempo que entoa um mantra. Ou ainda intercalar o japamala com uma
        meditação de respiração clássica, um método que ajuda a diminuir a taxa
        de respiração e concentração, promovendo maior relaxamento para a mente.{' '}
      </Text>
    ),
  },
];
